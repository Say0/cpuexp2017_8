...
let rec deref_term = function
  ...
  | Print_char(e1) -> Print_char(deref_term e1)
  | Print_float(e1) -> Print_float(deref_term e1)
  | Read_int(e1) -> Read_int(deref_term e1)
  | Read_float(e1) -> Read_float(deref_term e1)
